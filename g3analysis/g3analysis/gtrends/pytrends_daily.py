...
def get_daily_data(word: str,
    ...
    #pytrends = TrendReq(hl='en-US', tz=360, timeout=(10, 25), proxies=['https://34.203.233.13:80','https://35.201.123.31:880'], retries=2,
...
if __name__ == "__main__":
    ...
    df = get_daily_data("yemen", start_year=2005, start_mon=1, stop_year=2014, stop_mon=2, geo = '', cat = 1209, wait_time = 5.0)
    helpers.store_df(df=df, path_name="gtrends", file_name="yemen_2005-2014_cat1209")
